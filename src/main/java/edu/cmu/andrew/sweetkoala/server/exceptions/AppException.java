package edu.cmu.andrew.sweetkoala.server.exceptions;
...
import edu.cmu.andrew.sweetkoala.server.http.exceptions.HttpNotFoundException;
import edu.cmu.andrew.sweetkoala.server.http.exceptions.HttpUnauthorizedException;
